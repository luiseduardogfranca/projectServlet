insert into adm (first_name, last_name, email, born, `password`, description, gender) values ('Luís', 'Eduardo', 'luiseduardogfranca@gmail.com', '1998/11/23', '23111998', 'Amante da vida', 'masculino');
select * from adm;
